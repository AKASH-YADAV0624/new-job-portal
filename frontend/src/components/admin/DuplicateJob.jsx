...
const DuplicateJob=()=>{
   ...
   const changeEventHandler = (e, isSelect = false, fieldName = "") => {
    ...
    const submitHandler= async(e)=>{
        ...
        try{
            setLoading(true);
            const res= await axios.post(`${JOB_API_END_POINT}/duplicate/${params.id}`,input,{
  ...
  />
          ...
          <div className="w-full flex  mt-5">
           
            {
              ...
              onClick={submitHandler} className="text-white bg-green-600  py-2 rounded max560:w-full">
              Duplicate Job
          </Button>
            }
          </div>
